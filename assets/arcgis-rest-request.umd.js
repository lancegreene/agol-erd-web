/* @preserve
* @esri/arcgis-rest-request - v4.10.2 - Apache-2.0
* Copyright (c) 2017-2026 Esri, Inc.
* Tue Apr 07 2026 14:52:13 GMT+0000 (Coordinated Universal Time)
*/
(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     * ```
     */
    class ApplicationCredentialsManager extends AuthenticationManagerBase {
        /**
     ...
     */
    class ApiKeyManager extends AuthenticationManagerBase {
        /**
     ...
     */
    class ArcGISIdentityManager extends AuthenticationManagerBase {
        /**
        ...
        static completeOAuth2(options, win) {
            ...
            function createManager(oauthInfo, state) {
                win.localStorage.removeItem(stateStorageKey);
                if (popup && win.opener) {
                    win.opener.dispatchEvent(new CustomEvent(`arcgis-rest-js-popup-auth-${clientId}`, {
                        detail: Object.assign(Object.assign({}, oauthInfo), { state })
                    }));
                    win.close();
                    return;
                }
            ...
            if (!pkce && params.access_token) {
                return Promise.resolve(createManager(Object.assign({ token: params.access_token, expires: new Date(Date.now() + parseInt(params.expires_in, 10) * 1000), ssl: params.ssl === "true", username: params.username }, state), state));
            }
    ...
    exports.sendNoCorsRequest = sendNoCorsRequest;
